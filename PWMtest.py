...
task = 7
GPIO.setup(task,GPIO.OUT)
GPIO.setup(2, GPIO.OUT)  # Set GPIO pin 12 to output mode.
pwm = GPIO.PWM(2, 100)   # Initialize PWM on pwmPin 100Hz frequency
